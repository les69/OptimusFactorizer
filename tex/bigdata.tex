...
\begin{enumerate}
    ...
    \item Last but not least we have conducted a test to investigate the different running times between the two different versions of ALS : the naive
    and the weighted one. ADD RESULTS HERE
\end{enumerate}
