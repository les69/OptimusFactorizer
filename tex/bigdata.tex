...
\begin{description}
  \item[Lists] The first mistake we made was to use simple scala \textbf{Lists}. Altough their semplicity of use
  ...
  \item[RDD filtering] We needed to retrieve at each step the
\end{description}
